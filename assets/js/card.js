...
var CardValidator = (function () {
    function CardValidator() {
        _classCallCheck(this, CardValidator);
    }

    _createClass(CardValidator, null, [{
        key: "validateBin",
        value: function validateBin(card, num) {
            return card.regexpBin.test(Number(num));
        }
    }, {
        key: "validateCard",
        value: function validateCard(card, num) {
            return card.regexpFull.test(Number(num));
        }
    }, {
        key: "checkFlag",
        value: function checkFlag(num) {
        ...
        key: "checkFullCard",
        value: function checkFullCard(num) {
            for (var flag in FLAGS) {
