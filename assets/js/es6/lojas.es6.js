...
$(document).ready(function() {
    const map = new google.maps.Map($("#map-canvas").get(0), {
    ...
    $(lojas).each(function() {
        ...
        google.maps.event.addListener(loja.marker, "click", function() {
            ...
            const html = $("<div>").addClass("map-info");
            ...
            $("<p>")
                .append($("<span>").text("Telefone: "))
                .append(loja.telefone)
                .appendTo(html);
    ...
    $("[data-f4f-shop-view]").click(function() {
        const id = $(this).closest("[data-f4f-shop-id]").data("f4f-shop-id");
