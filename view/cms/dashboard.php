    ...
    <body>
        <div class="dash-wrapper">
            <div class="one card-dash">
                ...
                <span class="subtitle padding-left-20px">O serviço desktop pensado para facilitar a sua vida.</span>
                <p class="padding-left-20px">
                    Este software tem como objetivo controlar a área financeira e a administração geral da empresa Food 4Fit.
                    <br>
                    Caso ache necessário, veja o guia de ajuda de interface disponível logo abaixo para aprender sobre o software.
                </p>
